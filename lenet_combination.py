...
class LeNet_Combination(nn.Module) :
    def __init__(self, model1, model2) :
        ...
        for n, p in model1.named_parameters():
                model1_param_dict[n] = p
        for n, p in model2.named_parameters():
                model2_param_dict[n] = p
...
model = LeNet_Combination(model1, model2).to(device)
...
torch.save(model.state_dict(), './trained_model/lenet_combination_random_for_pmnist2.pt')
